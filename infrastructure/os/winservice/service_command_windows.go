...
// installService attempts to install the nautiliad service. Typically this should
...
// removeService attempts to uninstall the nautiliad service. Typically this should
...
// startService attempts to Start the nautiliad service.
